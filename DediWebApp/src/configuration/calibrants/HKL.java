package configuration.calibrants;
...
public class HKL implements Serializable, Cloneable {
	private static final long serialVersionUID = -8064663825884308732L;
	...
	public double getDNano() {
		...
		return d.doubleValue(SI.NANO(SI.METRE));
	}
	...
	public void setDNano(double d) {
		this.d = Amount.valueOf(d, SI.NANO(SI.METRE));
	}
